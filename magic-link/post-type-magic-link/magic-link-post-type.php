...
/**
 * Class Disciple_Tools_Meetings_Magic_Link
 */
class Disciple_Tools_Meetings_Magic_Link extends DT_Magic_Url_Base {
    ...
    public function wp_enqueue_scripts(){
        ...
        wp_localize_script(
            'magic_link_scripts', 'jsObject', [
                ...
                'parts' => $this->parts,
                'translations' => [
                    'add' => __( 'Add Magic', 'disciple-tools-meetings' ),
                ],
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === $this->post_type ){
            $tiles["dt_starters_magic_url"] = [
                "label" => __( "Magic Url", 'disciple-tools-meetings' ),
...
Disciple_Tools_Meetings_Magic_Link::instance();
